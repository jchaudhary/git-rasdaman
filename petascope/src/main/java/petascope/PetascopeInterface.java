...
//                    } else
                    if (service.equals(petascope.wcs2.parsers.BaseRequest.SERVICE)) {
                        ...
                        } else if (operation.equals(RequestHandler.DESCRIBE_COVERAGE) || operation.equals(RequestHandler.PROCESS_COVERAGE) || operation.equals(RequestHandler.GET_COVERAGE) || operation.equals(RequestHandler.DELETE_COVERAGE) || operation.equals(RequestHandler.INSERT_COVERAGE)) {
